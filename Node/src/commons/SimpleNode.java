...
public abstract class SimpleNode extends MIDlet {
    ...
    public int accelXValue = 0;
    public int accelYValue = 0;
    public int accelZValue = 0;
    ...
    public void readSensorValues() throws IOException {
        ...
        accelXValue = (int) acc.getAccelX();
        accelYValue = (int) acc.getAccelY();
        accelZValue = (int) acc.getAccelZ();
